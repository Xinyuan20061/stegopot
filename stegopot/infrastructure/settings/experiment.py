...
CONFIG_SCHEMA = {
    ...
    "properties": {
        ...
        "runtime": {"type": "object", "additionalProperties": False, "properties": {
            ...
            "max_tool_calls": {"type": "integer", "minimum": 1, "description": "整组实验通用受控工具调用次数上限"},
            "max_tool_calls_per_trial": {"type": "integer", "minimum": 1, "description": "单次试验通用受控工具调用上限"},
            "max_tool_calls_per_node": {"type": "integer", "minimum": 1, "description": "单次试验每节点通用受控工具调用上限"},
